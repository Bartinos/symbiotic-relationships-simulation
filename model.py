...
class SymbioticRelationshipsModel(Model):
    def __init__(self,
        ...
        Frog.create_agents(
            ...
            cell=self.random.choices(self.grid.all_cells.cells, k=initial_frogs), p_reproduce=p_reproduce_frog,
        )

        Snake.create_agents(
            self,
            initial_snakes, # Snake amount
            cell=self.random.choices(self.grid.all_cells.cells, k=initial_snakes), p_reproduce = p_reproduce_snake,
        )

        Ant.create_agents(
            self,
            initial_ants, # Ant amount
            cell=self.random.choices(self.grid.all_cells.cells, k=initial_ants), p_reproduce = p_reproduce_ant,
        )
